...
import { Story, Meta, ColorPalette, ColorItem, BooleanControl } from '@storybook/blocks';
  ...
  <table>
    ...
    <tbody>
      <tr>
        <td>큰 텍스트</td>
        <td>
            일반(Regular 400) 18px 이상 <span style={{ fontSize: '1em', color: '#7e7eaf' }}>혹은</span><br />
            굵게(Medium 600, Bold 700) 14px 이상
        </td>
        <td>
            AAA 4.5:1  <span style={{ fontSize: '1em', color: '#7e7eaf' }}>혹은</span><br />
            AA 3:1
        </td>
      </tr>
      <tr>
        <td>작은 텍스트</td>
        <td>
            일반(Regular 400) 17px 미만 <span style={{ fontSize: '1em', color: '#7e7eaf' }}>혹은</span><br />
            굵게(Medium 600, Bold 700) 13px 미만
        </td>
        <td>
            AAA 7:1  <span style={{ fontSize: '1em', color: '#7e7eaf' }}>혹은</span><br />
            AA 4.5:1
        </td>
      </tr>
    </tbody>
...
export function Palette() {
    ...
    return (
        <>
            ...
            <label for="control-Storybook-팔레트-표시" aria-label="Storybook 팔레트 표시" className={className} style={{ marginBottom: '1rem' }}>
                ...
                <span aria-hidden="true">KRDS식 팔레트</span>
                <span aria-hidden="true">Storybook 팔레트</span>
            </label>
            {storybook ? (
                <ColorPalette>
